...
const writeups = ref([
	  { title: 'Laboratorios PortSwigger', platform: 'PortSwigger', os: 'Windows/Linux', difficulty: 'Fácil', link: 'https://beafn28.gitbook.io/beafn28/web-security/laboratorios-portswigger' },
