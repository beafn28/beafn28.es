...
const writeups = ref([
            { title: 'Controler', platform: 'Vulnyx', os: 'Windows', difficulty: 'Media', link: 'https://beafn28.gitbook.io/beafn28/writeups/vulnyx/controler' },
            { title: 'Change', platform: 'Vulnyx', os: 'Windows', difficulty: 'Media', link: 'https://beafn28.gitbook.io/beafn28/writeups/vulnyx/change' },
	  { title: 'Laboratorios PortSwigger', platform: 'PortSwigger', os: 'Windows/Linux', difficulty: 'Todo', link: 'https://beafn28.gitbook.io/beafn28/web-security/laboratorios-portswigger' },
